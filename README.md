...
the following five axioms are for the type analysis (inference and checking):  
    ...
    8. ${\displaystyle {\Gamma \vdash A := B \qquad \qquad \Pi \vdash B: T \over \Pi \vdash A : T}}$    
    9. ${\displaystyle {\Pi \vdash f: (T_1, T_2) \mapsto T_3 \qquad \qquad x, y \in \mathbf{V} \over \Pi, x: T_1, y: T_2 \vdash f(x, y): T_3}}$    
    10. ${\displaystyle {\Pi, x: T_x \vdash A: T_A \qquad \qquad \Pi, A[x/Y]: T_A \vdash Y: T_x \over \Pi \vdash A[x/Y] : T_A}}$    
